...
var varSubnetConfigurations = (!empty(parSubnetConfigurations)) ? parSubnetConfigurations : (parIsHubNetwork) ? [
  {
...
resource resVnet 'Microsoft.Network/virtualNetworks@2023-05-01' = {
  ...
  properties: {
    ...
    subnets: [for subnet in varSubnetConfigurations: {
      name: subnet.name
      properties: {
...
resource resRouteTableVpnGateway 'Microsoft.Network/routeTables@2023-05-01' = if (parIsHubNetwork) {
  ...
  tags: parTags
  properties: {
    routes: [for (spokeNetwork, index) in parSpokeNetworks: {
      name: 'to-spoke-${index}'
      properties: {
...
module modVpnGateway 'vpn_gateway.bicep' = if (parIsHubNetwork) {
  name: 'modVpnGateway'
  params: {
