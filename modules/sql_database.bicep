...
var varPrivateDnsZoneId = (parUsePrivateEndpoint ? resourceId(parPrivateDnsZoneResourceGroup, 'Microsoft.Network/privateDnsZones', varPrivateDnsZoneName) : '') 
...
resource resAllowedSubnets 'Microsoft.Sql/servers/virtualNetworkRules@2023-05-01-preview' = [for (allowedSubnet, index) in parAllowedSubnetIds: {
